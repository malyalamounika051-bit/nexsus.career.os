...
const roadmapPhaseSchema = new mongoose.Schema({
  ...
  resumeUpdate: { type: String },
  githubTarget: { type: String },
...
const careerSchema = new mongoose.Schema({
  ...
  availableWeeklyHours: { type: Number, default: 10 },
  learningStyle: { type: String, enum: ['Visual', 'Practical', 'Academic', 'Mixed'], default: 'Mixed' },
